...
import '../data/map_data.dart' as map_data; // <--- Use prefix
...
class PropertyProvider extends ChangeNotifier {
  ...
  map_data.MapData? _mapData; // <--- Use prefixed type
  ...
  map_data.MapData? get mapData => _mapData; // <--- Getter
  ...
  Future<void> loadProperties({int page = 1}) async {
    ...
    try {
      ...
      _mapData = response.data.maps; // <--- Assign prefixed MapData
    } catch (e) {
