...
- Create a new virtual device (e.g., Pixel 6) and click **Run** to launch the emulator. 
...
**C. Admin Role (Security & Monitoring)**
  ...
  - **Security Check**: Intentionally fail a login attempt 5 times. Access the **Anomaly 
